...
const App = memo(function () {
  ...
  const isEmployeeSelected = useSelector<AppRootStateType, boolean>(
    (state) => state.app.isEmployeeSelected
  );
  const isAppInitialized = useSelector<AppRootStateType, boolean>(
    ...
    <div>
      ...
      <div className={classes.mainAppBlock}>
        ...
        <Routes>
          <Route
            path={'/'}
            element={!isEmployeeSelected && <div>Select One</div>}
          />
